...
public class ArithmeticTest
{
    ...
    public void TestPushPop()
    {
        ...
        cpu.Push(cpu.RegisterA, cpu.RegisterB);

        cpu.Pop(ref cpu.RegisterC, ref cpu.RegisterD);
        
        Assert.Equal(cpu.RegisterA, cpu.RegisterC);
        Assert.Equal(cpu.RegisterB, cpu.RegisterD);
    }
}